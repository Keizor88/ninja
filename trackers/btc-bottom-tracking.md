...
**Trigger:** `btc tracking update`
**Baseline:** per 22-23 Agu · **refresh live sebelum eksekusi**

---

## Dashboard 5-Layer

1. **Harga/momentum** — BTC ~$79.5K (+26% dari $62.9K), rally via short-squeeze rekor **$2.74B**.
2. **Struktur bounce** — leverage-driven: futures 12x, **spot lemah**, Coinbase premium **negatif ~80 hari**. Bull-trap ~55%.
3. **Bahan bakar (fuel)** — PENUH: Hash Ribbons **BUY**, Reserve Risk **low**, DXY **lemah**, China M2 naik.
4. **Ignition** — **OFF**: net liquidity ketat, Warsh hawkish.
5. **Rotasi** — BTC leg, **no altseason** (BTC.D ~60%, TOTAL2 berdarah).

---

## Distribusi Bottom ("bottom di mana")

- Modal skenario **$50-58K (~40%)** · expected **~$49-50K**
- **~58% ≥$50K · ~90% ≥$34K · ~96% ≥$30K · sub-$30K ~4%**
- **Timing: Okt-Des 2026** (siaga Oktober)

---

## Entry Plan (BELI di flush Q4 2026 — pada SINYAL)

| Tranche | Zona | Catatan |
|---|---|---|
| T2 | $54-58K | first ladder |
| T3 | $46-52K | core add |
| T4 | $38-44K | deep flush |
| T5 | <$38K | capitulation tail |

## Exit Plan (JUAL Sep-Nov 2029)

- Target **~$180-250K**, ladder **E1-E4**
- Sinyal jual: **memes pump lebar** = bel exit
- Hold ~3 tahun
...
BTC price · funding · Coinbase premium (flip?) · BTC.D · TOTAL2/3 · ETF flow

## Decider terdekat

PCE 26 Agu (08:30 ET, core MoM kons. 0.2%) · Warsh keynote 28 Agu. Base ekonom = HOLD sisa 2026.

---

# 🔄 LIVE UPDATE 25-26 Agu 2026 — REVISI THESIS (hard data)

## Harga
Peak **>$81K** (25 Agu), pullback ke **~$78.5K** (profit-taking pra-PCE). Masih di ATAS support $69K (ATH 2021).

## ⚠️ 2 dari 4 pilar thesis flush REFUTED
| Pilar | Status |
|---|---|
| 1. Bounce leverage-driven | ❌ **REFUTED** — funding DI BAWAH netral |
| 2. Spot lemah | ❌ **REFUTED** — net ETF +$2.57B/7 sesi |
| 3. Ignition OFF (net liq) | ⏳ pending |
| 4. Warsh hawkish | ⏳ pending (PCE/Jumat) |

### Funding (Coinglass, 25 Agu) — di bawah netral 0.0100%/8h
BTC: Binance 0.0090% · OKX 0.0083% · **Bybit 0.0019%** · KuCoin 0.0051%
ETH: 0.0090/0.0100/0.0021/0.0044 · SOL: 0.0047/0.0024/**-0.0010**/**-0.0083** · HYPE: 0.0050/0.0071/0.0100/0.0050
→ BTC ann. **~2-10%** vs tripwire 0.03% (=32.9% ann) = **1/3–1/15 dari tripwire.** Rally BUKAN leverage.

### Positioning NET SHORT (L/S 24h, semua <1.0)
Binance 0.9478 · OKX 0.9581 · Bybit 0.9272 · Gate 0.9410 · Bitget 0.9234 · Hyperliquid 0.9179 · MEXC 0.9704
Liq 24h: **Long ~$78M vs Short ~$13M (6x)** → long telat udah ke-flush di $81K, posisi ke-reset.

### ETF NET flow (Farside — regime FLIP)
| Periode | BTC | ETH |
|---|---|---|
| 7-14 Agu | **-$283.5M** | negatif/flat |
| **17-25 Agu** | **+$2,570M** | **+$988M** |
| 25 Agu | +$314.3M (IBIT $284.4 = 90%) | +$179.8M |

### Lainnya
- **HY OAS ~270bps** (25 Agu) → ✅ di bawah tripwire 300-350
